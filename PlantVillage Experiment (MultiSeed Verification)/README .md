...
6. [Configuration and hyperparameters](#6-configuration-and-hyperparameters)
7. [Pipeline internals (code walkthrough)](#7-pipeline-internals-code-walkthrough)
8. [Outputs: what every file means](#8-outputs-what-every-file-means)
9. [Results](#9-results)
10. [Per-class analysis](#10-per-class-analysis)
11. [Overfitting & integrity diagnostics](#11-overfitting--integrity-diagnostics)
...
## 7. Pipeline internals (code walkthrough)
...
## 8. Outputs: what every file means
...
### 9.1 Multi-seed (v4 — the numbers to cite; validation set, mean ± std over 3 seeds)
...
### 9.2 Single-seed (v2 — all three budgets, validation accuracy)
...
### 9.3 Per-seed best validation accuracy (v4 appendix)
...
## 11. Overfitting & integrity diagnostics
...
- **Reference config** is fully listed in §6; SimCLR converged from NT-Xent loss **4.07 → 3.72**
  over 10 epochs.
